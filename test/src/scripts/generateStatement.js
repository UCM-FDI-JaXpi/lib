export function generateStatementFromZero(verbId, objectId, parameters) {
    let parameter = "";
...
export function generateStatement(player, verb, object, result, context, authority) {
    const statement = {
        actor: {
...
export function generateObject(objectJson, name, description) {
    const object = {
        id: objectJson.id,
        definition: {
